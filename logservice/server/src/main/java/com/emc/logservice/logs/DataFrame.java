...
public class DataFrame {
     ...
     *
     * @param startMagic The start magic value, used to verify that frames are read back in the same sequence they were written.
     *                   When sequencing frames, the previous frame's End Magic must match the subsequent frame Start Magic.
     * @param maxSize    The maximum size of the frame, including Frame Header and other control structures that the frame
    ...
    /**
     * Gets a value indicating the Start Magic number for this frame.
     * When sequencing frames, the previous frame's End Magic must match the subsequent frame Start Magic.
    ...
    /**
     * Gets a value indicating the End Magic number for this frame.
     * When sequencing frames, the previous frame's End Magic must match the subsequent frame Start Magic.
     * This value is serialized with the frame.
     *
     * @return
     ...
     *
     * @param data The ByteArraySegment to add.
    ...
    private void formatForWriting(int startMagic) {
        ...
        this.header = new FrameHeader(CurrentVersion, startMagic, this.data.subSegment(0, FrameHeader.SerializationLength));
    ...
    private class FrameHeader {
        ...
        private final int startMagic;
        private final byte version;
        private final int endMagic;
         ...
         * @param startMagic The Start Magic number for the frame.
        ...
        public FrameHeader(byte version, int startMagic, ByteArraySegment target) {
            ...
            this.endMagic = MagicGenerator.newMagic();
        ...
        public FrameHeader(ByteArraySegment source) throws SerializationException {
            ...
            try (DataInputStream input = new DataInputStream(source.getReader())) {
                ...
                this.startMagic = input.readInt();
                this.endMagic = input.readInt();
        ...
        /**
         * Gets a value indicating the Start Magic number for the frame.
         *
         * @return
         */
        public int getStartMagic() {
        ...
        /**
         * Gets a value indicating the End Magic number for the frame.
         *
         * @return
         */
        public int getEndMagic() {
