...
final class ExecutorServiceFactory {
    ...
    @FunctionalInterface
    private interface CreateShrinkingExecutorService {
        ThreadPoolScheduledExecutorService apply(int corePoolSize, int maxPoolSize, int keepAliveTime, ThreadFactory factory);
    }
