...
public final class MetricsNames {
    ...
    public static final String SEGMENTS_COUNT = "segments_count";   // Dynamic Guage
    public static final String SEGMENTS_SPLITS = "segments_splits"; // Dynamic Counter
    public static final String SEGMENTS_MERGES = "segments_merges"; // Dynamic Counter
