...
public final class ServiceBuilder implements AutoCloseable {
     ...
     * @return Newly created StreamSegmentStore.
     */
     ...
     * @return In-memory service builder instance.
     */
    ...
    public static class ComponentSetup {
         ...
         * @return ServiceBuilder's SegmentContainer Registry.
         */
         ...
         * @return ServiceBuilder's SegmentContainer Mapper.
         */
         ...
         * @return ServiceBuilder's Executor.
         */
