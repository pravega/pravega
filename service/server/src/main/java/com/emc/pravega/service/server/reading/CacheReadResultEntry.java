...
class CacheReadResultEntry extends ReadResultEntryBase {
     ...
     *
     * @param streamSegmentOffset The offset within the StreamSegment where this ReadResultEntry starts at. NOTE: this
     *                            is not where the first byte of 'data' starts, rather it's where dataOffset points to
     *                            in the StreamSegment.
