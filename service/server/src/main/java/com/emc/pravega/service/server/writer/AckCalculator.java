...
class AckCalculator {
     ...
     * aggregator
     * has the property that, within the context of that Aggregator alone, all Operations that have a Sequence Number
     * (SN)
     * smaller than LUSN have been committed to Storage. As such, picking the smallest of all LUSN values across
     * all the active SegmentAggregators will give us the highest SN that can be safely truncated out of the
     * OperationLog.
