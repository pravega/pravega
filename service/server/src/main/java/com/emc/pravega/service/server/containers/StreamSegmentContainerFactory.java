...
public class StreamSegmentContainerFactory implements SegmentContainerFactory {
     ...
     */
    public StreamSegmentContainerFactory(MetadataRepository metadataRepository, OperationLogFactory operationLogFactory, ReadIndexFactory readIndexFactory, StorageFactory storageFactory, CacheFactory cacheFactory, Executor executor) {
    ...
    public SegmentContainer createStreamSegmentContainer(int containerId) {
        return new StreamSegmentContainer(containerId, this.metadataRepository, this.operationLogFactory, this.readIndexFactory, this.storageFactory, this.cacheFactory, this.executor);
    }
}
