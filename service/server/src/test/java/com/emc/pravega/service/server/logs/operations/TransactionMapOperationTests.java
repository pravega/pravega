...
public class TransactionMapOperationTests extends OperationTestsBase<TransactionMapOperation> {
    ...
    protected TransactionMapOperation createOperation(Random random) {
        return new TransactionMapOperation(random.nextLong(), new StreamSegmentInformation(super.getStreamSegmentName(random.nextLong()), random.nextLong(), random.nextBoolean(), random.nextBoolean(), new Date(), autoScale, targetRate, rateType));
    }
