...
public class HDFSStorage { //implements Storage {
    ...
    //
    //    @Override
    //    public CompletableFuture<SegmentHandle> open(String streamSegmentName) {
    //        return this.storage.supplyAsync(() -> acquireLockForSegmentSync(streamSegmentName), streamSegmentName);
    //    }
    //
    //    @Override
    ...
    //     * </ol>
    //     */
    //    private HDFSSegmentHandle acquireLockForSegmentSync(String streamSegmentName) throws IOException, StreamSegmentNotExistsException {
    ...
    //        }
    //
    //        String physicalSegmentName = getOwnedSegmentFullPath(streamSegmentName);
    //        this.storage.rename(statuses[0].getPath(), new Path(physicalSegmentName));
    //        return new HDFSSegmentHandle(streamSegmentName, physicalSegmentName);
    //    }
    //
    //    //endregion
}
