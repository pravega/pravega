...
/**
 * TODO: do not check this in. Delete me.
...
@Deprecated
@Slf4j
public class HDFSStorageRename  implements Storage {
    //region Members
     ...
     */
    HDFSStorageRename(HDFSStorageConfig config, Executor executor) {
    ...
    public CompletableFuture<Void> seal(SegmentHandle handle, Duration timeout) {
        ...
        return runAsync(() -> sealSync(handle.getSegmentName()), handle.getSegmentName());
    }
    ...
    private SegmentHandle openWithFencing(String streamSegmentName) throws IOException {
        ...
        if (isSealed(status)) {
            ...
            //return  HDFSSegmentHandle(streamSegmentName, false, 0);
        }
        ...
        //return new HDFSSegmentHandle(streamSegmentName, false, 0);
        return null;
    }
    ...
    private SegmentHandle openWithoutFencing(String streamSegmentName) throws IOException {
        ...
        //return new HDFSSegmentHandle(streamSegmentName, true, 0);
        return null;
    }
    ...
    private void sealSync(String streamSegmentName) throws IOException, StorageNotPrimaryException {
        String ownedFullPath = getOwnedSegmentFullPath(streamSegmentName);
        long traceId = LoggerHelpers.traceEnter(log, "seal", streamSegmentName, ownedFullPath);

        // Seal is idempotent. If a segment is already sealed, nothing is to be done. Because of this, we only require
