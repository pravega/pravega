...
/**
 * Helper class to handle async behavior of Tier2 HDFS implementation.
 */
public class HDFSFutureHelper {
    /**
     ...
     *
     * @param streamSegmentName The execution happens for this StreamSegment.
     ...
     */
    public static <T> CompletableFuture<T> runGivenCodeInFutureAndHandleException(String streamSegmentName,
                                                                            Callable<T> function, Executor executor) {
