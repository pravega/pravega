...
class HDFSLowerStorage { //implements Storage {
    ...
    //        throw new UnsupportedOperationException("open is not supported in HDFSLowerStorage.");
    //    }
    //
    //    @Override
    ...
    //    }
    //
    //    <T> CompletableFuture<T> supplyAsync(Callable<T> syncCode, String streamSegmentName) {
    //        ensureInitializedAndNotClosed();
