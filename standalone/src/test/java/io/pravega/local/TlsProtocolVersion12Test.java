...
public class TlsProtocolVersion12Test {
    ...
    @ClassRule
    public static final PravegaEmulatorResource EMULATOR = new PravegaEmulatorResource.PravegaEmulatorResourceBuilder(false, true, false).tlsProtocolVersion("TLSv1.2").build();
