 ...
 */
package io.pravega.segmentstore.server.host.rest;

import com.google.common.util.concurrent.AbstractIdleService;
import io.pravega.client.netty.impl.ConnectionFactory;
import io.pravega.common.LoggerHelpers;
import io.pravega.common.auth.JKSHelper;
import io.pravega.segmentstore.server.host.rest.resources.PingImpl;
import io.pravega.segmentstore.server.rpc.auth.AuthHandlerManager;
import io.pravega.segmentstore.server.host.rest.resources.StreamDataResourceImpl;
...
public class RESTServer extends AbstractIdleService {
    ...
    public RESTServer(StreamSegmentService streamSegmentService, AuthHandlerManager pravegaAuthManager, RESTServerConfig restServerConfig, ConnectionFactory connectionFactory) {
        ...
        resourceObjs.add(new StreamDataResourceImpl(streamSegmentService, pravegaAuthManager, connectionFactory));
