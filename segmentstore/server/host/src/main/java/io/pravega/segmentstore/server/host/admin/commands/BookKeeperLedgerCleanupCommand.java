 ...
 */
public class BookKeeperLedgerCleanupCommand extends BookKeeperCommand {
    /**
     * Creates a new instance of the BookKeeperLedgerCleanupCommand.
     *
     * @param args The arguments for the command.
     */
    BookKeeperLedgerCleanupCommand(CommandArgs args) {
        super(args);
    }
