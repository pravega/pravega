...
public class StorageEventProcessorTests  extends ThreadPooledTestSuite {
    ...
    public void testInvalidArgs() throws Exception {
        ...
        AssertExtensions.assertThrows("Should not allow null chunkedSegmentStorage",
                () -> {
                    @Cleanup val x = new StorageEventProcessor(CONTAINER_ID, mockEventProcessor, null);
                },
                ex -> ex instanceof NullPointerException);

        // Create valid instance
        @Cleanup val x = new StorageEventProcessor(CONTAINER_ID, mockEventProcessor, storage);
