...
public interface WriterSegmentProcessor extends AutoCloseable {
    ...
    /**
     * Gets a value indicating whether a call to flush() is required given the current state of this Segment Processor.
     */
    boolean mustFlush();

    /**
     * Adds the given SegmentOperation to the Processor.
     *
