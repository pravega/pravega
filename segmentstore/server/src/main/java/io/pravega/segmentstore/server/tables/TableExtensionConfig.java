...
public class TableExtensionConfig {
    ...
    public static final Property<Boolean> COMPACTION_ENABLED = Property.named("compaction.enabled", true);
    ...
    private TableExtensionConfig(TypedProperties properties) throws ConfigurationException {
        ...
        this.isCompactionEnabled = properties.getBoolean(COMPACTION_ENABLED);
