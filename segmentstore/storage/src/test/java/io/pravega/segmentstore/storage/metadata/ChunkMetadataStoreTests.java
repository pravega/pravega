...
public class ChunkMetadataStoreTests {
    ...
    public void testDelete() throws Exception {
        try (MetadataTransaction txn = metadataStore.beginTransaction()) {
            ...
            txn.create(new TestData(KEY0, VALUE0));
        ...
        try (MetadataTransaction txn = metadataStore.beginTransaction()) {
            ...
            txn.create(new TestData(KEY0, VALUE0));
            assertEquals((TestData) txn.get(KEY0), KEY0, VALUE0);
            txn.commit();
        }
    ...
    public void testSimpleScenario() throws Exception {
        try (MetadataTransaction txn = metadataStore.beginTransaction()) {
            ...
            // Create data
            txn.create(new TestData(KEY0, VALUE0));
            txn.create(new TestData(KEY1, VALUE1));
            txn.create(new TestData(KEY2, VALUE2));

            assertEquals((TestData) txn.get(KEY0), KEY0, VALUE0);
            assertEquals((TestData) txn.get(KEY1), KEY1, VALUE1);
            assertEquals((TestData) txn.get(KEY2), KEY2, VALUE2);

            // Update
            txn.update(new TestData(KEY1, VALUE4));
            assertEquals((TestData) txn.get(KEY0), KEY0, VALUE0);
            assertEquals((TestData) txn.get(KEY1), KEY1, VALUE4);
            assertEquals((TestData) txn.get(KEY2), KEY2, VALUE2);

            // create
            txn.create(new TestData(KEY3, VALUE5));
            assertEquals((TestData) txn.get(KEY0), KEY0, VALUE0);
            assertEquals((TestData) txn.get(KEY1), KEY1, VALUE4);
            assertEquals((TestData) txn.get(KEY2), KEY2, VALUE2);
            assertEquals((TestData) txn.get(KEY3), KEY3, VALUE5);
        ...
        assertEquals((TestData) metadataStore.read(KEY0).getValue(), KEY0, VALUE0);
        assertEquals((TestData) metadataStore.read(KEY1).getValue(), KEY1, VALUE4);
        ...
        try (MetadataTransaction txn2 = metadataStore.beginTransaction()) {
            assertEquals((TestData) txn2.get(KEY0), KEY0, VALUE0);
            assertEquals((TestData) txn2.get(KEY1), KEY1, VALUE4);
            Assert.assertNull(txn2.get(KEY3));

            txn2.update(new TestData(KEY0, VALUE6));
            txn2.delete(KEY1);
            assertEquals((TestData) txn2.get(KEY0), KEY0, VALUE6);
            Assert.assertNull(txn2.get(KEY3));
        ...
        try (MetadataTransaction txn3 = metadataStore.beginTransaction()) {
            assertEquals((TestData) txn3.get(KEY0), KEY0, VALUE0);
            assertEquals((TestData) txn3.get(KEY1), KEY1, VALUE4);
    ...
    public void testLazyCommitWithNormalCommitWithNoBuffer() throws Exception {
        ...
        // make sure they are stored correctly
        assertEquals((TestData) metadataStore.read(KEY0).getValue(), KEY0, VALUE0);
        assertEquals((TestData) metadataStore.read(KEY1).getValue(), KEY1, VALUE1);
        assertEquals((TestData) metadataStore.read(KEY2).getValue(), KEY2, VALUE2);

        try (MetadataTransaction txn1 = metadataStore.beginTransaction()) {
            // Update
            txn1.update(new TestData(KEY1, VALUE4));
            assertEquals((TestData) txn1.get(KEY0), KEY0, VALUE0);
            assertEquals((TestData) txn1.get(KEY1), KEY1, VALUE4);
            assertEquals((TestData) txn1.get(KEY2), KEY2, VALUE2);
        ...
        try (MetadataTransaction txn4 = metadataStore.beginTransaction()) {
            // Update
            txn4.update(new TestData(KEY0, VALUE5));
            txn4.update(new TestData(KEY1, VALUE6));
            assertEquals((TestData) txn4.get(KEY0), KEY0, VALUE5);
            assertEquals((TestData) txn4.get(KEY1), KEY1, VALUE6);
        ...
        assertEquals((TestData) metadataStore.read(KEY0).getValue(), KEY0, VALUE5);
        Assert.assertNull(metadataStore.read(KEY1).getValue());
        Assert.assertNull(metadataStore.read(KEY2).getValue());
    }
    ...
    public void testTransactionFailedForMultipleUpdates() throws Exception {
        ...
        try (MetadataTransaction txn = metadataStore.beginTransaction()) {
            ...
            txn.create(new TestData(KEY0, VALUE0));
            txn.create(new TestData(KEY1, VALUE1));
            txn.create(new TestData(KEY3, VALUE2));

            assertEquals((TestData) txn.get(KEY0), KEY0, VALUE0);
            assertEquals((TestData) txn.get(KEY1), KEY1, VALUE1);
            assertEquals((TestData) txn.get(KEY3), KEY3, VALUE2);
        ...
        try (MetadataTransaction txn0 = metadataStore.beginTransaction()) {
            ...
            txn0.update(new TestData(KEY0, VALUE5));
            assertEquals((TestData) txn0.get(KEY0), KEY0, VALUE5);
            assertEquals((TestData) txn0.get(KEY3), KEY3, VALUE2);
            ...
            try (MetadataTransaction txn2 = metadataStore.beginTransaction()) {
                ...
                txn2.update(new TestData(KEY0, VALUE6));
                assertEquals((TestData) txn2.get(KEY0), KEY0, VALUE6);
                assertEquals((TestData) txn2.get(KEY3), KEY3, VALUE2);
    ...
    public static class TestData implements StorageMetadata {
