...
public class StorageExtraConfig {
    ...
    public static final Property<Boolean> STORAGE_NO_OP_MODE = Property.named("noOpMode.enable", false, "storageNoOpMode");
    public static final Property<Integer> STORAGE_WRITE_NO_OP_LATENCY = Property.named("write.noOp.latency.milliseconds", 20, "storageWriteNoOpLatencyMillis");
