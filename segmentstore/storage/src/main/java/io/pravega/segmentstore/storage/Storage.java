...
public interface Storage extends ReadOnlyStorage, AutoCloseable {
     ...
     * the segment for read and write activities (ex: read, get, write, seal, concat). In case of a sealed SegmentHandle
     * a read-only handle is returned. If the operation failed, it will be failed with the cause of the failure. Notable exceptions:
     * <ul>
