...
public class BookKeeperLogFactory implements DurableDataLogFactory {
    ...
    private BookKeeper startBookKeeperClient() throws Exception {
        ...
        config.setProperty(CommonConfigurationKeys.NET_TOPOLOGY_SCRIPT_FILE_NAME_KEY, "/opt/pravega/scripts/bookkeeper-topology.sh");
        log.info("SET TOPOLOGY FILE FOR BOOKKEEPER: /opt/pravega/scripts/bookkeeper-topology.sh");
