...
public interface ReaderGroup extends ReaderGroupNotificationListener, AutoCloseable {
    ...
    /**
     * Generate a StreamCut after co-ordinating with all the readers using
     * {@link io.pravega.client.state.StateSynchronizer}. All the readers return
     * the latest read offsets of their assigned segments and this is used to generate
     * a {@link StreamCut}.
     * The configuration {@link ReaderGroupConfig#getGroupRefreshTimeMillis()} decides
     * the maximum delay by which the readers return the latest read offsets of their
     * assigned segments.
     * <p>
     * The {@link StreamCut} generated by this API can be used by the application as
     * reference to position in the Stream, which is guaranteed to be greater than or
     * equal to the position of the readers at the point of invocation of the API.
     *
