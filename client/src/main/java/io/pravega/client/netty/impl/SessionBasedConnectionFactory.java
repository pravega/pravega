 ...
 */
@Slf4j
public class SessionBasedConnectionFactory implements ConnectionFactory {
    ...
    public SessionBasedConnectionFactory(ClientConfig clientConfig) {
        this(clientConfig, new ConnectionPoolImpl(clientConfig), (Integer) null);
    }

    @VisibleForTesting
    public SessionBasedConnectionFactory(ClientConfig clientConfig, ConnectionPool connectionPool, Integer numThreadsInPool) {
    ...
    public CompletableFuture<ClientConnection> establishConnection(PravegaNodeUri endpoint, ReplyProcessor rp) {
        throw new UnsupportedOperationException("This api will be removed once Connection pooling is enabled");
    }
