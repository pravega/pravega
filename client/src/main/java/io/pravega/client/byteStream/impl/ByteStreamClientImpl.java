...
public class ByteStreamClientImpl implements ByteStreamClient {
    ...
    @Override
    public ByteStreamReader createByteStreamReaders(Segment segment) {  
        return new ByteStreamReaderImpl(inputStreamFactory.createInputStreamForSegment(segment));
    }

    @Override
    public ByteStreamWriter createByteStreamWriter(Segment segment, EventWriterConfig config) {
