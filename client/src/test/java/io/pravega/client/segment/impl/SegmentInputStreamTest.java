...
public class SegmentInputStreamTest {
    ...
    public void testEndOfSegment() throws EndOfSegmentException, SegmentTruncatedException {
        ...
        @Cleanup
        EventSegmentInputStreamImpl stream1 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(fakeNetwork, 0);
        ...
        @Cleanup
        EventSegmentInputStreamImpl stream2 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(fakeNetwork, 0);
        ...
        fakeNetwork = new TestAsyncSegmentInputStream(segment, 2);
        @Cleanup
        EventSegmentInputStreamImpl stream3 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(fakeNetwork, 0);
        ...
        fakeNetwork = new TestAsyncSegmentInputStream(segment, 2);
        @Cleanup
        EventSegmentInputStreamImpl stream4 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(fakeNetwork, 0);
        ...
        @Cleanup
        EventSegmentInputStreamImpl stream5 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(fakeNetwork, 0);
    ...
    public void testReadWithEndOffset() throws Exception {
        ...
        @Cleanup
        EventSegmentInputStreamImpl stream = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(mockAsyncInputStream, 0, wireDataSize,
    ...
    public void testReadWithEndOffsetWithDataGreaterThanBuffer() throws Exception {
        ...
        @Cleanup
        EventSegmentInputStreamImpl stream = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(mockAsyncInputStream, 0, wireDataSize, bufferSize);
    ...
    public void testReadWithInvalidEndOffset() {
        ...
        @Cleanup
        EventSegmentInputStreamImpl stream = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(mockAsyncInputStream, 0,
    ...
    public void testOrderer() throws EndOfSegmentException, SegmentTruncatedException {
        ...
        @Cleanup
        EventSegmentInputStreamImpl stream1 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(fakeNetwork1, 0);
        @Cleanup
        EventSegmentInputStreamImpl stream2 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(fakeNetwork2, 0);
        @Cleanup
        EventSegmentInputStreamImpl stream3 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(fakeNetwork3, 0);
        @Cleanup
        EventSegmentInputStreamImpl stream4 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(fakeNetwork4, 0);
        @Cleanup
        EventSegmentInputStreamImpl stream5 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(fakeNetwork5, 0);
        ...
        List<EventSegmentInputStreamImpl> segments = ImmutableList.of(stream1, stream2, stream3, stream4, stream5);
    ...
    public void testRefillSize() throws EndOfSegmentException, SegmentTruncatedException {
        ...
        @Cleanup
        EventSegmentInputStreamImpl stream1 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(mockAsyncInputStream, 0);
        ...
        @Cleanup
        EventSegmentInputStreamImpl stream2 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(mockAsyncInputStream, 0, wireDataSize, bufferSize);
        ...
        when(mockAsyncInputStream.read(0, 100)).thenReturn(
                                                           completedFuture(new SegmentRead(segment.getScopedName(), 0, false, false, wireData.slice())));
        @Cleanup
        EventSegmentInputStreamImpl stream3 = SegmentInputStreamFactoryImpl.getEventSegmentInputStream(mockAsyncInputStream, 0, Long.MAX_VALUE, 100);
