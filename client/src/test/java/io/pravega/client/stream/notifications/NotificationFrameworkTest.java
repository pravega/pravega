...
public class NotificationFrameworkTest {
    ...
    NotificationSystem readerGroupNotifier = NotificationSystem.INSTANCE;
    ...
    public void scaleEventTest() {
        ...
        ScaleEventNotifier notifier = new ScaleEventNotifier();
        ...
        readerGroupNotifier.notify(ScaleEvent.builder().numOfSegments(3).numOfReaders(4).build());
        assertTrue("Scale Event notification received", scaleEventReceived.get());

        scaleEventReceived.set(false);

        //Trigger notification.
        readerGroupNotifier.notify(ScaleEvent.builder().numOfSegments(5).numOfReaders(4).build());
        assertTrue("Scale Event notification received", scaleEventReceived.get());
        ...
        readerGroupNotifier.removeListeners(listener1);
        readerGroupNotifier.removeListeners(listener2);
    ...
    public void multipleEventTest() {
        ...
        ScaleEventNotifier scaleNotifier = new ScaleEventNotifier();
        ...
        //trigger notifications
        readerGroupNotifier.notify(CustomEvent.builder().build());
