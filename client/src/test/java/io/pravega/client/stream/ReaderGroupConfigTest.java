...
public class ReaderGroupConfigTest {
    ...
    public void testTruncateAtUserStreamCut() {
        ...
        assertEquals(getStreamCut("s1"), cfg.getStartingStreamCuts().get(Stream.of("scope/s1")));
        assertEquals(getStreamCut("s2"), cfg.getStartingStreamCuts().get(Stream.of("scope/s2")));
        assertEquals(ReaderGroupConfig.StreamDataRetention.MANUAL_RELEASE_AT_USER_STREAMCUT, cfg.getRetentionType());
    }
    ...
    public void testTruncateAtLastCheckpoint() {
        ...
        assertEquals(getStreamCut("s1"), cfg.getStartingStreamCuts().get(Stream.of("scope/s1")));
        assertEquals(getStreamCut("s2"), cfg.getStartingStreamCuts().get(Stream.of("scope/s2")));
        assertEquals(ReaderGroupConfig.StreamDataRetention.AUTOMATIC_RELEASE_AT_LAST_CHECKPOINT, cfg.getRetentionType());
    }
    ...
    public void testValidConfig() {
        ...
        assertEquals(getStreamCut("s1"), cfg.getStartingStreamCuts().get(Stream.of("scope/s1")));
        assertEquals(getStreamCut("s2"), cfg.getStartingStreamCuts().get(Stream.of("scope/s2")));
        assertEquals(ReaderGroupConfig.StreamDataRetention.NONE, cfg.getRetentionType());
    }
    ...
    @Test
    public void testReaderGroupConfigRetentionTypeSerialization() {
