 ...
 */
package com.emc.nautilus.stream.segment.impl;
...
public class SegmentOutputStreamImpl extends SegmentOutputStream {
	...
	/**
	 * @see com.emc.nautilus.stream.segment.SegmentOutputStream#write(java.nio.ByteBuffer, java.util.concurrent.CompletableFuture)
	 */
	@Override
	@Synchronized
	...
	/**
	 * @see com.emc.nautilus.stream.segment.SegmentOutputStream#close()
	 */
	@Override
	@Synchronized
	...
	/**
	 * @see com.emc.nautilus.stream.segment.SegmentOutputStream#flush()
	 */
	@Override
	@Synchronized
