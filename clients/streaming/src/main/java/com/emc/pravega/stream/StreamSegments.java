...
public class StreamSegments {
     ...
     *
     * @param segments Segments of a stream, keyed by the largest key in their key range. IE: If there are two segments
     *                 split evenly, the first should have a value of 0.5 and the second 1.0.
     */
