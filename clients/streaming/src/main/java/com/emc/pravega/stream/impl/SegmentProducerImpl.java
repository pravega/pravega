...
public class SegmentProducerImpl<Type> implements SegmentProducer<Type> {
    ...
    private final Vector<WriterEvent<Type>> outstanding = new Vector<>();
    ...
    @Override
    public void publish(WriterEvent<Type> m) throws SegmentSealedException {
    ...
    @Override
    public List<WriterEvent<Type>> getUnackedEvents() {
