...
public interface Producer<Type> extends AutoCloseable {
     ...
     * service host failures. Internal retries will not violate the exactly once semantic so it is
     * better to rely on them than to wrap this with custom retry logic.
     * 
