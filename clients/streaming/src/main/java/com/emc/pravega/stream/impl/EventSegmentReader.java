 ...
 */
public interface EventSegmentReader<Type> extends AutoCloseable {
    ...
    /**
     * Given an offset obtained from {@link EventSegmentReader#getOffset()} reset consumption to that position.
     *
