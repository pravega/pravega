...
Samples
readme](https://github.com/pravega/pravega-samples/blob/${variable.pravega_samples_verion}/pravega-client-examples/README.md).
...
Synchronizer [here.](https://github.com/pravega/pravega-samples/tree/${variable.pravega_samples_verion}/pravega-client-examples/src/main/java/io/pravega/example/statesynchronizer)
