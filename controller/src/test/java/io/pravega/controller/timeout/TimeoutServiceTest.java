...
public class TimeoutServiceTest {
    ...
    public TimeoutServiceTest() throws Exception {
        ...
        streamMetadataTasks = new StreamMetadataTasks(streamStore, StreamStoreFactory.createInMemoryBucketStore(), hostStore, taskMetadataStore,
                new SegmentHelper(hostControllerStore, clientCF, authHelper), executor, hostId, connectionFactory, AuthHelper.getDisabledAuthHelper(), requestTracker);
        ...
        controllerService = new ControllerService(streamStore, hostStore, streamMetadataTasks,
                streamTransactionMetadataTasks, new SegmentHelper(hostControllerStore, clientCF, authHelper), executor, null);
    ...
    public void testPingOwnershipTransfer() throws Exception {
        ...
        StreamMetadataTasks streamMetadataTasks2 = new StreamMetadataTasks(streamStore2, bucketStore, hostStore, taskMetadataStore,
                new SegmentHelper(hostControllerStore, clientCF, authHelper), executor, "2", connectionFactory,  AuthHelper.getDisabledAuthHelper(), requestTracker);
        @Cleanup
        ...
        ControllerService controllerService2 = new ControllerService(streamStore2, hostStore, streamMetadataTasks2,
                streamTransactionMetadataTasks2, new SegmentHelper(hostControllerStore, clientCF, authHelper), executor, null);
