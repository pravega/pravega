...
public class ZkStreamTest {
    ...
    public void testCreateStream() throws ExecutionException, InterruptedException {
        ...
        CreateStreamResponse response = zkStream.checkStreamExists(streamConfig1, creationTime1).get();
        assertEquals(CreateStreamResponse.CreateStatus.NEW, response.getStatus());
        zkStream.storeCreationTimeIfNotExists(creationTime1).get();

        response = zkStream.checkStreamExists(streamConfig1, creationTime1).get();
        assertEquals(CreateStreamResponse.CreateStatus.NEW, response.getStatus());
        response = zkStream.checkStreamExists(streamConfig2, creationTime1).get();
        assertEquals(CreateStreamResponse.CreateStatus.NEW, response.getStatus());
        response = zkStream.checkStreamExists(streamConfig2, creationTime2).get();
        assertEquals(CreateStreamResponse.CreateStatus.NEW, response.getStatus());

        zkStream.createConfigurationIfNotExists(streamConfig1).get();
        ...
        zkStream.createStateIfNotExists(State.UNKNOWN).get();
        ...
        zkStream.updateState(State.CREATING).get();
        ...
        zkStream.updateState(State.ACTIVE).get();
        ...
        zkStream.updateState(State.SEALING).get();
