...
public class StreamMetadataTasksTest {
    ...
    public void sealStreamTest() throws Exception {
        ...
        //seal a stream.
        UpdateStreamStatus.Status sealOperationResult = streamMetadataTasks.sealStream(SCOPE, stream1, null).get();
    ...
    public void manualScaleTest() throws Exception {
        ...
        List<Segment> segments = streamMetadataTasks.startScale((ScaleOpEvent) requestEventWriter.getEvent(), true, context).get();
