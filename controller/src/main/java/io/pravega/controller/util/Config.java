...
public final class Config {
    ...
    public static final Property<Boolean> PROPERTY_INTERNAL_WRITES_WITH_READ_PERMISSIONS = Property.named(
            "security.auth.internalStreams.writesWithReadPermissions.enable", true);
    ...
    public static final boolean INTERNAL_WRITES_WITH_READ_PERMISSIONS;
    ...
    static {
        ...
        INTERNAL_WRITES_WITH_READ_PERMISSIONS = p.getBoolean(PROPERTY_INTERNAL_WRITES_WITH_READ_PERMISSIONS);
    ...
    private static GRPCServerConfig createGrpcServerConfig() {
        ...
        return GRPCServerConfigImpl.builder()
                ...
                .internalWritesWithReadPermEnabled(Config.INTERNAL_WRITES_WITH_READ_PERMISSIONS)
