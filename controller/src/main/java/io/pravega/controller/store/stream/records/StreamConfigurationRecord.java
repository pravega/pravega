...
public class StreamConfigurationRecord {
    ...
    private static class StreamConfigurationRecordSerializer
            extends VersionedSerializer.WithBuilder<StreamConfigurationRecord,
            StreamConfigurationRecord.StreamConfigurationRecordBuilder> {
        @Override
        protected byte getWriteVersion() {
            return 0;
        }
        ...
        private void read00(RevisionDataInput revisionDataInput,
                            StreamConfigurationRecord.StreamConfigurationRecordBuilder streamConfigurationRecordBuilder)
                throws IOException {
        ...
        @Override
        protected StreamConfigurationRecord.StreamConfigurationRecordBuilder newBuilder() {
