...
public class KeyValueTableStoreFactory {
    ...
    public static KVTableMetadataStore createStore(final StoreClient storeClient, final SegmentHelper segmentHelper,
        ...
        switch (storeClient.getType()) {
            case PravegaTable:
                return new PravegaTablesKVTableMetadataStore(segmentHelper, (CuratorFramework) storeClient.getClient(), executor, authHelper);
            default:
    ...
    public static KVTableMetadataStore createPravegaTablesStore(final SegmentHelper segmentHelper, final GrpcAuthHelper authHelper,
        ...
        return new PravegaTablesKVTableMetadataStore(segmentHelper, client, executor, authHelper);
    }
