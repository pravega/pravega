 ...
 * However, every time the number of connections go beyond a certain capacity
 */
@Slf4j
class SegmentHelperConnectionManager {
    private static final int MAX_AVAILABLE_CONNECTION = 100;
    ...
    // This will not make any new connection request but wait for available connection object. 
