 ...
 */
@Slf4j
public class AddSubscriberTask implements StreamTask<AddSubscriberEvent> {

    private final StreamMetadataTasks streamMetadataTasks;
    private final StreamMetadataStore streamMetadataStore;
    private final ScheduledExecutorService executor;

    public AddSubscriberTask(final StreamMetadataTasks streamMetadataTasks,
    ...
    @Override
    public CompletableFuture<Void> execute(final AddSubscriberEvent request) {
    ...
    @Override
    public CompletableFuture<Void> writeBack(AddSubscriberEvent event) {
        return streamMetadataTasks.writeEvent(event);
    }

    @Override
    public CompletableFuture<Boolean> hasTaskStarted(AddSubscriberEvent event) {
