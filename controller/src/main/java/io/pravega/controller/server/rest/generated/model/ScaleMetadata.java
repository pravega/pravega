...
public class ScaleMetadata   {
  ...
  @JsonProperty("merges")
  private Integer merges = null;

  public ScaleMetadata timestamp(Integer timestamp) {
  ...
  public ScaleMetadata splits(Integer splits) {
    this.splits = splits;
    return this;
  }
  ...
  public ScaleMetadata merges(Integer merges) {
    this.merges = merges;
    return this;
  }
