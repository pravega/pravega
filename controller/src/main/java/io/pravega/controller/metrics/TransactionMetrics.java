...
import static io.pravega.shared.MetricsNames.CONTROLLER_EVENT_PROCESSOR_COMMIT_TRANSACTION_STREAM_LATENCY;
...
public final class TransactionMetrics extends AbstractControllerMetrics {
    ...
    private final OpStatsLogger controllerEventProcessorCommitTransactionStreamLatency;
    ...
    private TransactionMetrics() {
        ...
        controllerEventProcessorCommitTransactionStreamLatency = STATS_LOGGER.createStats(CONTROLLER_EVENT_PROCESSOR_COMMIT_TRANSACTION_STREAM_LATENCY);
    }
    ...
    /**
     * This method reports the latency of ControllerEventProcessor commitTransaction Stream event processing.
     *
     * @param latency       Latency of the controllerEventProcessorCommitTransactionStreamLatency event operation.
     */
    public void controllerEventProcessorCommitTransactionStreamLatency(Duration latency) {
        controllerEventProcessorCommitTransactionStreamLatency.reportSuccessValue(latency.toMillis());
    }
    ...
    public static synchronized void reset() {
        ...
        if (old != null) {
            ...
            old.controllerEventProcessorCommitTransactionStreamLatency.close();
        }
        INSTANCE.set(new TransactionMetrics());
    }
}
