...
public class SegmentRange implements org.apache.thrift.TBase<SegmentRange, SegmentRange._Fields>, java.io
        .Serializable, Cloneable, Comparable<SegmentRange> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
            "SegmentRange");

    private static final org.apache.thrift.protocol.TField SEGMENT_ID_FIELD_DESC = new org.apache.thrift.protocol
            .TField(
            "segmentId", org.apache.thrift.protocol.TType.STRUCT, (short) 1);
    private static final org.apache.thrift.protocol.TField MIN_KEY_FIELD_DESC = new org.apache.thrift.protocol.TField(
            "minKey", org.apache.thrift.protocol.TType.DOUBLE, (short) 2);
    private static final org.apache.thrift.protocol.TField MAX_KEY_FIELD_DESC = new org.apache.thrift.protocol.TField(
            "maxKey", org.apache.thrift.protocol.TType.DOUBLE, (short) 3);
    ...
    static {
        Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift
                ...
                _Fields.class);
        tmpMap.put(_Fields.SEGMENT_ID, new org.apache.thrift.meta_data.FieldMetaData("segmentId",
                org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
                        SegmentId.class)));
        tmpMap.put(_Fields.MIN_KEY, new org.apache.thrift.meta_data.FieldMetaData("minKey",
                org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
        tmpMap.put(_Fields.MAX_KEY, new org.apache.thrift.meta_data.FieldMetaData("maxKey",
                org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    ...
    public SegmentRange(SegmentId segmentId, double minKey, double maxKey) {
        this();
    ...
    public boolean equals(Object that) {
        ...
        if (that instanceof SegmentRange) return this.equals((SegmentRange) that);
        return false;
    }
    ...
    public boolean equals(SegmentRange that) {
        ...
        if (this_present_segmentId || that_present_segmentId) {
            if (!(this_present_segmentId && that_present_segmentId)) return false;
            if (!this.segmentId.equals(that.segmentId)) return false;
        }

        boolean this_present_minKey = true;
        boolean that_present_minKey = true;
        if (this_present_minKey || that_present_minKey) {
            if (!(this_present_minKey && that_present_minKey)) return false;
            if (this.minKey != that.minKey) return false;
        }

        boolean this_present_maxKey = true;
        boolean that_present_maxKey = true;
        if (this_present_maxKey || that_present_maxKey) {
            if (!(this_present_maxKey && that_present_maxKey)) return false;
            if (this.maxKey != that.maxKey) return false;
        }
    ...
    public int hashCode() {
        ...
        if (present_segmentId) list.add(segmentId);

        boolean present_minKey = true;
        list.add(present_minKey);
        if (present_minKey) list.add(minKey);

        boolean present_maxKey = true;
        list.add(present_maxKey);
        if (present_maxKey) list.add(maxKey);
    ...
    public void validate() throws org.apache.thrift.TException {
        ...
        if (segmentId == null) {
            throw new org.apache.thrift.protocol.TProtocolException(
                    "Required field 'segmentId' was not present! Struct: " + toString());
        }
    ...
    private static class SegmentRangeStandardScheme extends StandardScheme<SegmentRange> {
        ...
        public void read(org.apache.thrift.protocol.TProtocol iprot, SegmentRange struct) throws org.apache.thrift
                .TException {
            ...
            if (!struct.isSetMinKey()) {
                throw new org.apache.thrift.protocol.TProtocolException(
                        "Required field 'minKey' was not found in serialized data! Struct: " + toString());
            }
            if (!struct.isSetMaxKey()) {
                throw new org.apache.thrift.protocol.TProtocolException(
                        "Required field 'maxKey' was not found in serialized data! Struct: " + toString());
            }
            struct.validate();
        }
