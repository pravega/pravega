...
public class SegmentId implements org.apache.thrift.TBase<SegmentId, SegmentId._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final int __PREVIOUS_ISSET_ID = 1;
  ...
  static {
    ...
    tmpMap.put(_Fields.PREVIOUS, new org.apache.thrift.meta_data.FieldMetaData("previous", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public SegmentId setPrevious(int previous) {
    this.previous = previous;
    setPreviousIsSet(true);
    return this;
  }
  ...
  public void unsetPrevious() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __PREVIOUS_ISSET_ID);
  }

  /** Returns true if field previous is set (has been assigned a value) and false otherwise */
  public boolean isSetPrevious() {
    return EncodingUtils.testBit(__isset_bitfield, __PREVIOUS_ISSET_ID);
  }

  public void setPreviousIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __PREVIOUS_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case PREVIOUS:
      return Integer.valueOf(getPrevious());
  ...
  public boolean equals(SegmentId that) {
    ...
    boolean this_present_previous = true;
    boolean that_present_previous = true;
  ...
  public int hashCode() {
    ...
    boolean present_previous = true;
    builder.append(present_previous);
    if (present_previous)
  ...
  public int compareTo(SegmentId other) {
    ...
    SegmentId typedOther = (SegmentId)other;
    ...
    lastComparison = Boolean.valueOf(isSetPrevious()).compareTo(typedOther.isSetPrevious());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPrevious()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.previous, typedOther.previous);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class SegmentIdStandardScheme extends StandardScheme<SegmentId> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, SegmentId struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetPrevious()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'previous' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
