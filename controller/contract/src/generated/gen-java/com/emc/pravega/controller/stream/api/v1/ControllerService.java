...
public class ControllerService {
  ...
  public interface Iface {
    ...
    public TxnId createTransaction(String scope, String stream, long lease, long maxExecutionTime, long scaleGracePeriod) throws org.apache.thrift.TException;
    ...
    public PingStatus pingTransaction(String scope, String stream, TxnId txnid, long lease) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void createTransaction(String scope, String stream, long lease, long maxExecutionTime, long scaleGracePeriod, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void pingTransaction(String scope, String stream, TxnId txnid, long lease, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public TxnId createTransaction(String scope, String stream, long lease, long maxExecutionTime, long scaleGracePeriod) throws org.apache.thrift.TException
    {
      send_createTransaction(scope, stream, lease, maxExecutionTime, scaleGracePeriod);
      return recv_createTransaction();
    }

    public void send_createTransaction(String scope, String stream, long lease, long maxExecutionTime, long scaleGracePeriod) throws org.apache.thrift.TException
    {
      createTransaction_args args = new createTransaction_args();
      args.setScope(scope);
      args.setStream(stream);
      args.setLease(lease);
      args.setMaxExecutionTime(maxExecutionTime);
      args.setScaleGracePeriod(scaleGracePeriod);
    ...
    public PingStatus pingTransaction(String scope, String stream, TxnId txnid, long lease) throws org.apache.thrift.TException
    {
      send_pingTransaction(scope, stream, txnid, lease);
      return recv_pingTransaction();
    }

    public void send_pingTransaction(String scope, String stream, TxnId txnid, long lease) throws org.apache.thrift.TException
    {
      pingTransaction_args args = new pingTransaction_args();
      args.setScope(scope);
      args.setStream(stream);
      args.setTxnid(txnid);
      args.setLease(lease);
      sendBase("pingTransaction", args);
    }

    public PingStatus recv_pingTransaction() throws org.apache.thrift.TException
    {
      pingTransaction_result result = new pingTransaction_result();
      receiveBase(result, "pingTransaction");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "pingTransaction failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void createTransaction(String scope, String stream, long lease, long maxExecutionTime, long scaleGracePeriod, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      createTransaction_call method_call = new createTransaction_call(scope, stream, lease, maxExecutionTime, scaleGracePeriod, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class createTransaction_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private long scaleGracePeriod;
      public createTransaction_call(String scope, String stream, long lease, long maxExecutionTime, long scaleGracePeriod, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.scope = scope;
        this.stream = stream;
        this.lease = lease;
    ...
    public void pingTransaction(String scope, String stream, TxnId txnid, long lease, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      pingTransaction_call method_call = new pingTransaction_call(scope, stream, txnid, lease, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class pingTransaction_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String scope;
      private String stream;
      private TxnId txnid;
      private long lease;
      public pingTransaction_call(String scope, String stream, TxnId txnid, long lease, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.scope = scope;
        this.stream = stream;
        this.txnid = txnid;
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("pingTransaction", org.apache.thrift.protocol.TMessageType.CALL, 0));
        pingTransaction_args args = new pingTransaction_args();
        args.setScope(scope);
        args.setStream(stream);
        args.setTxnid(txnid);
      ...
      public PingStatus getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_pingTransaction();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("pingTransaction", new pingTransaction());
    ...
    public static class createTransaction<I extends Iface> extends org.apache.thrift.ProcessFunction<I, createTransaction_args> {
      ...
      public createTransaction_result getResult(I iface, createTransaction_args args) throws org.apache.thrift.TException {
        createTransaction_result result = new createTransaction_result();
        result.success = iface.createTransaction(args.scope, args.stream, args.lease, args.maxExecutionTime, args.scaleGracePeriod);
        return result;
      }
    }
    ...
    public static class pingTransaction<I extends Iface> extends org.apache.thrift.ProcessFunction<I, pingTransaction_args> {
      public pingTransaction() {
        super("pingTransaction");
      }

      public pingTransaction_args getEmptyArgsInstance() {
        return new pingTransaction_args();
      }
      ...
      public pingTransaction_result getResult(I iface, pingTransaction_args args) throws org.apache.thrift.TException {
        pingTransaction_result result = new pingTransaction_result();
        result.success = iface.pingTransaction(args.scope, args.stream, args.txnid, args.lease);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class createTransaction<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, createTransaction_args, TxnId> {
      ...
      public void start(I iface, createTransaction_args args, org.apache.thrift.async.AsyncMethodCallback<TxnId> resultHandler) throws TException {
        iface.createTransaction(args.scope, args.stream, args.lease, args.maxExecutionTime, args.scaleGracePeriod,resultHandler);
      }
    }
    ...
    public static class pingTransaction<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, pingTransaction_args, PingStatus> {
      public pingTransaction() {
        super("pingTransaction");
      }
      ...
      public AsyncMethodCallback<PingStatus> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<PingStatus>() { 
          public void onComplete(PingStatus o) {
            pingTransaction_result result = new pingTransaction_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, pingTransaction_args args, org.apache.thrift.async.AsyncMethodCallback<PingStatus> resultHandler) throws TException {
        iface.pingTransaction(args.scope, args.stream, args.txnid, args.lease,resultHandler);
      }
    }
  ...
  public static class createTransaction_args implements org.apache.thrift.TBase<createTransaction_args, createTransaction_args._Fields>, java.io.Serializable, Cloneable, Comparable<createTransaction_args>   {
    ...
    private static final org.apache.thrift.protocol.TField SCOPE_FIELD_DESC = new org.apache.thrift.protocol.TField("scope", org.apache.thrift.protocol.TType.STRING, (short)1);
    private static final org.apache.thrift.protocol.TField STREAM_FIELD_DESC = new org.apache.thrift.protocol.TField("stream", org.apache.thrift.protocol.TType.STRING, (short)2);
    private static final org.apache.thrift.protocol.TField LEASE_FIELD_DESC = new org.apache.thrift.protocol.TField("lease", org.apache.thrift.protocol.TType.I64, (short)3);
    private static final org.apache.thrift.protocol.TField MAX_EXECUTION_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("maxExecutionTime", org.apache.thrift.protocol.TType.I64, (short)4);
    private static final org.apache.thrift.protocol.TField SCALE_GRACE_PERIOD_FIELD_DESC = new org.apache.thrift.protocol.TField("scaleGracePeriod", org.apache.thrift.protocol.TType.I64, (short)5);
    ...
    private String scope; // required
    private String stream; // required
    private long lease; // required
    private long maxExecutionTime; // required
    private long scaleGracePeriod; // required
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ...
      STREAM((short)2, "stream"),
      LEASE((short)3, "lease"),
      MAX_EXECUTION_TIME((short)4, "maxExecutionTime"),
      SCALE_GRACE_PERIOD((short)5, "scaleGracePeriod");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          ...
          case 3: // LEASE
            return LEASE;
          case 4: // MAX_EXECUTION_TIME
            return MAX_EXECUTION_TIME;
          case 5: // SCALE_GRACE_PERIOD
            return SCALE_GRACE_PERIOD;
          default:
            return null;
        }
      }
    ...
    // isset id assignments
    private static final int __LEASE_ISSET_ID = 0;
    private static final int __MAXEXECUTIONTIME_ISSET_ID = 1;
    private static final int __SCALEGRACEPERIOD_ISSET_ID = 2;
    private byte __isset_bitfield = 0;
    public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      ...
      tmpMap.put(_Fields.LEASE, new org.apache.thrift.meta_data.FieldMetaData("lease", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
      tmpMap.put(_Fields.MAX_EXECUTION_TIME, new org.apache.thrift.meta_data.FieldMetaData("maxExecutionTime", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
      tmpMap.put(_Fields.SCALE_GRACE_PERIOD, new org.apache.thrift.meta_data.FieldMetaData("scaleGracePeriod", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public createTransaction_args(createTransaction_args other) {
      ...
      this.scaleGracePeriod = other.scaleGracePeriod;
    }
    ...
    public void clear() {
      ...
      setLeaseIsSet(false);
      this.lease = 0;
      setMaxExecutionTimeIsSet(false);
      this.maxExecutionTime = 0;
      setScaleGracePeriodIsSet(false);
      this.scaleGracePeriod = 0;
    }
    ...
    public createTransaction_args setLease(long lease) {
      this.lease = lease;
      setLeaseIsSet(true);
      return this;
    }
    ...
    public void unsetLease() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __LEASE_ISSET_ID);
    }

    /** Returns true if field lease is set (has been assigned a value) and false otherwise */
    public boolean isSetLease() {
      return EncodingUtils.testBit(__isset_bitfield, __LEASE_ISSET_ID);
    }

    public void setLeaseIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __LEASE_ISSET_ID, value);
    }
    ...
    public createTransaction_args setMaxExecutionTime(long maxExecutionTime) {
      this.maxExecutionTime = maxExecutionTime;
      setMaxExecutionTimeIsSet(true);
      return this;
    }
    ...
    public void unsetMaxExecutionTime() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __MAXEXECUTIONTIME_ISSET_ID);
    }
    ...
    public boolean isSetMaxExecutionTime() {
      return EncodingUtils.testBit(__isset_bitfield, __MAXEXECUTIONTIME_ISSET_ID);
    }

    public void setMaxExecutionTimeIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __MAXEXECUTIONTIME_ISSET_ID, value);
    }
    ...
    public createTransaction_args setScaleGracePeriod(long scaleGracePeriod) {
      this.scaleGracePeriod = scaleGracePeriod;
      setScaleGracePeriodIsSet(true);
      return this;
    }

    public void unsetScaleGracePeriod() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SCALEGRACEPERIOD_ISSET_ID);
    }

    /** Returns true if field scaleGracePeriod is set (has been assigned a value) and false otherwise */
    public boolean isSetScaleGracePeriod() {
      return EncodingUtils.testBit(__isset_bitfield, __SCALEGRACEPERIOD_ISSET_ID);
    }

    public void setScaleGracePeriodIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SCALEGRACEPERIOD_ISSET_ID, value);
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SCALE_GRACE_PERIOD:
        if (value == null) {
          unsetScaleGracePeriod();
        } else {
          setScaleGracePeriod((Long)value);
        }
        break;
    ...
    public boolean equals(createTransaction_args that) {
      ...
      boolean this_present_maxExecutionTime = true;
      boolean that_present_maxExecutionTime = true;
      ...
      boolean this_present_scaleGracePeriod = true;
      boolean that_present_scaleGracePeriod = true;
      if (this_present_scaleGracePeriod || that_present_scaleGracePeriod) {
        if (!(this_present_scaleGracePeriod && that_present_scaleGracePeriod))
          return false;
        if (this.scaleGracePeriod != that.scaleGracePeriod)
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_lease = true;
      list.add(present_lease);
      if (present_lease)
        list.add(lease);

      boolean present_maxExecutionTime = true;
      list.add(present_maxExecutionTime);
      if (present_maxExecutionTime)
        list.add(maxExecutionTime);

      boolean present_scaleGracePeriod = true;
      list.add(present_scaleGracePeriod);
      if (present_scaleGracePeriod)
        list.add(scaleGracePeriod);
    ...
    public int compareTo(createTransaction_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetLease()).compareTo(other.isSetLease());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetLease()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lease, other.lease);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
      lastComparison = Boolean.valueOf(isSetMaxExecutionTime()).compareTo(other.isSetMaxExecutionTime());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetMaxExecutionTime()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.maxExecutionTime, other.maxExecutionTime);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
      lastComparison = Boolean.valueOf(isSetScaleGracePeriod()).compareTo(other.isSetScaleGracePeriod());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetScaleGracePeriod()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.scaleGracePeriod, other.scaleGracePeriod);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("scaleGracePeriod:");
      sb.append(this.scaleGracePeriod);
      first = false;
      sb.append(")");
      return sb.toString();
    }
    ...
    private static class createTransaction_argsStandardScheme extends StandardScheme<createTransaction_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, createTransaction_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 5: // SCALE_GRACE_PERIOD
              if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
                struct.scaleGracePeriod = iprot.readI64();
                struct.setScaleGracePeriodIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, createTransaction_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeI64(struct.lease);
        oprot.writeFieldEnd();
        oprot.writeFieldBegin(MAX_EXECUTION_TIME_FIELD_DESC);
        oprot.writeI64(struct.maxExecutionTime);
        oprot.writeFieldEnd();
        oprot.writeFieldBegin(SCALE_GRACE_PERIOD_FIELD_DESC);
        oprot.writeI64(struct.scaleGracePeriod);
        oprot.writeFieldEnd();
        oprot.writeFieldStop();
        oprot.writeStructEnd();
      }
    ...
    private static class createTransaction_argsTupleScheme extends TupleScheme<createTransaction_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, createTransaction_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetScaleGracePeriod()) {
          optionals.set(4);
        }
        oprot.writeBitSet(optionals, 5);
        if (struct.isSetScope()) {
  ...
  public static class pingTransaction_args implements org.apache.thrift.TBase<pingTransaction_args, pingTransaction_args._Fields>, java.io.Serializable, Cloneable, Comparable<pingTransaction_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("pingTransaction_args");

    private static final org.apache.thrift.protocol.TField SCOPE_FIELD_DESC = new org.apache.thrift.protocol.TField("scope", org.apache.thrift.protocol.TType.STRING, (short)1);
    private static final org.apache.thrift.protocol.TField STREAM_FIELD_DESC = new org.apache.thrift.protocol.TField("stream", org.apache.thrift.protocol.TType.STRING, (short)2);
    private static final org.apache.thrift.protocol.TField TXNID_FIELD_DESC = new org.apache.thrift.protocol.TField("txnid", org.apache.thrift.protocol.TType.STRUCT, (short)3);
    private static final org.apache.thrift.protocol.TField LEASE_FIELD_DESC = new org.apache.thrift.protocol.TField("lease", org.apache.thrift.protocol.TType.I64, (short)4);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new pingTransaction_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new pingTransaction_argsTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.LEASE, new org.apache.thrift.meta_data.FieldMetaData("lease", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(pingTransaction_args.class, metaDataMap);
    }

    public pingTransaction_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public pingTransaction_args(pingTransaction_args other) {
      __isset_bitfield = other.__isset_bitfield;
      if (other.isSetScope()) {
        this.scope = other.scope;
      }
    ...
    public pingTransaction_args deepCopy() {
      return new pingTransaction_args(this);
    }
    ...
    public pingTransaction_args setScope(String scope) {
      this.scope = scope;
      return this;
    }
    ...
    public pingTransaction_args setStream(String stream) {
      this.stream = stream;
      return this;
    }
    ...
    public pingTransaction_args setTxnid(TxnId txnid) {
      this.txnid = txnid;
      return this;
    }
    ...
    public pingTransaction_args setLease(long lease) {
      this.lease = lease;
      setLeaseIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof pingTransaction_args)
        return this.equals((pingTransaction_args)that);
      return false;
    }

    public boolean equals(pingTransaction_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(pingTransaction_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("pingTransaction_args(");
      boolean first = true;
    ...
    private static class pingTransaction_argsStandardSchemeFactory implements SchemeFactory {
      public pingTransaction_argsStandardScheme getScheme() {
        return new pingTransaction_argsStandardScheme();
      }
    }

    private static class pingTransaction_argsStandardScheme extends StandardScheme<pingTransaction_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, pingTransaction_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pingTransaction_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class pingTransaction_argsTupleSchemeFactory implements SchemeFactory {
      public pingTransaction_argsTupleScheme getScheme() {
        return new pingTransaction_argsTupleScheme();
      }
    }

    private static class pingTransaction_argsTupleScheme extends TupleScheme<pingTransaction_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, pingTransaction_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetScope()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, pingTransaction_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(4);
        if (incoming.get(0)) {
          struct.scope = iprot.readString();
  ...
  public static class pingTransaction_result implements org.apache.thrift.TBase<pingTransaction_result, pingTransaction_result._Fields>, java.io.Serializable, Cloneable, Comparable<pingTransaction_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("pingTransaction_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.I32, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new pingTransaction_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new pingTransaction_resultTupleSchemeFactory());
    }

    private PingStatus success; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, PingStatus.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(pingTransaction_result.class, metaDataMap);
    }

    public pingTransaction_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public pingTransaction_result(pingTransaction_result other) {
      if (other.isSetSuccess()) {
        this.success = other.success;
      }
    }

    public pingTransaction_result deepCopy() {
      return new pingTransaction_result(this);
    }
     ...
     * @see PingStatus
     */
    public pingTransaction_result setSuccess(PingStatus success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof pingTransaction_result)
        return this.equals((pingTransaction_result)that);
      return false;
    }

    public boolean equals(pingTransaction_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(pingTransaction_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("pingTransaction_result(");
      boolean first = true;
    ...
    private static class pingTransaction_resultStandardSchemeFactory implements SchemeFactory {
      public pingTransaction_resultStandardScheme getScheme() {
        return new pingTransaction_resultStandardScheme();
      }
    }

    private static class pingTransaction_resultStandardScheme extends StandardScheme<pingTransaction_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, pingTransaction_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.success = com.emc.pravega.controller.stream.api.v1.PingStatus.findByValue(iprot.readI32());
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pingTransaction_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class pingTransaction_resultTupleSchemeFactory implements SchemeFactory {
      public pingTransaction_resultTupleScheme getScheme() {
        return new pingTransaction_resultTupleScheme();
      }
    }

    private static class pingTransaction_resultTupleScheme extends TupleScheme<pingTransaction_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, pingTransaction_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, pingTransaction_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = com.emc.pravega.controller.stream.api.v1.PingStatus.findByValue(iprot.readI32());
