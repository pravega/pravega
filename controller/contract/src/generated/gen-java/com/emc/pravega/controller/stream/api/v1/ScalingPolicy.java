...
public class ScalingPolicy implements org.apache.thrift.TBase<ScalingPolicy, ScalingPolicy._Fields>, java.io.Serializable, Cloneable {
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case TARGET_RATE:
      return Long.valueOf(getTargetRate());

    case SCALE_FACTOR:
      return Integer.valueOf(getScaleFactor());

    case MIN_NUM_SEGMENTS:
      return Integer.valueOf(getMinNumSegments());
  ...
  public int compareTo(ScalingPolicy other) {
    ...
    ScalingPolicy typedOther = (ScalingPolicy)other;
    ...
    lastComparison = Boolean.valueOf(isSetTargetRate()).compareTo(typedOther.isSetTargetRate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTargetRate()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.targetRate, typedOther.targetRate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetScaleFactor()).compareTo(typedOther.isSetScaleFactor());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetScaleFactor()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.scaleFactor, typedOther.scaleFactor);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetMinNumSegments()).compareTo(typedOther.isSetMinNumSegments());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMinNumSegments()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.minNumSegments, typedOther.minNumSegments);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = ScalingPolicyType.findByValue(iprot.readI32());
