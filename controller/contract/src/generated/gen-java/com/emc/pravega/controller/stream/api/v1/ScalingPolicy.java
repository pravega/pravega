...
public class ScalingPolicy implements org.apache.thrift.TBase<ScalingPolicy, ScalingPolicy._Fields>, java.io
        .Serializable, Cloneable, Comparable<ScalingPolicy> {
    ...
    private static final org.apache.thrift.protocol.TField TARGET_RATE_FIELD_DESC = new org.apache.thrift.protocol
            .TField(
            "targetRate", org.apache.thrift.protocol.TType.I64, (short) 2);
    private static final org.apache.thrift.protocol.TField SCALE_FACTOR_FIELD_DESC = new org.apache.thrift.protocol
            .TField(
            "scaleFactor", org.apache.thrift.protocol.TType.I32, (short) 3);
    private static final org.apache.thrift.protocol.TField MIN_NUM_SEGMENTS_FIELD_DESC = new org.apache.thrift
            .protocol.TField(
            "minNumSegments", org.apache.thrift.protocol.TType.I32, (short) 4);
        ...
        tmpMap.put(_Fields.TYPE,
                new org.apache.thrift.meta_data.FieldMetaData("type", org.apache.thrift.TFieldRequirementType.REQUIRED,
                        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM,
                                ScalingPolicyType.class)));
        tmpMap.put(_Fields.TARGET_RATE, new org.apache.thrift.meta_data.FieldMetaData("targetRate",
                org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
        tmpMap.put(_Fields.SCALE_FACTOR, new org.apache.thrift.meta_data.FieldMetaData("scaleFactor",
                org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
        tmpMap.put(_Fields.MIN_NUM_SEGMENTS, new org.apache.thrift.meta_data.FieldMetaData("minNumSegments",
                org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    ...
    public ScalingPolicy(ScalingPolicyType type, long targetRate, int scaleFactor, int minNumSegments) {
        this();
        this.type = type;
    ...
    public boolean equals(Object that) {
        ...
        if (that instanceof ScalingPolicy) return this.equals((ScalingPolicy) that);
        return false;
    }
    ...
    public boolean equals(ScalingPolicy that) {
        ...
        if (this_present_targetRate || that_present_targetRate) {
            if (!(this_present_targetRate && that_present_targetRate)) return false;
            if (this.targetRate != that.targetRate) return false;
        }
        ...
        if (this_present_scaleFactor || that_present_scaleFactor) {
            if (!(this_present_scaleFactor && that_present_scaleFactor)) return false;
            if (this.scaleFactor != that.scaleFactor) return false;
        }
        ...
        if (this_present_minNumSegments || that_present_minNumSegments) {
            if (!(this_present_minNumSegments && that_present_minNumSegments)) return false;
            if (this.minNumSegments != that.minNumSegments) return false;
        }
    ...
    public int hashCode() {
        ...
        if (present_targetRate) list.add(targetRate);

        boolean present_scaleFactor = true;
        list.add(present_scaleFactor);
        if (present_scaleFactor) list.add(scaleFactor);

        boolean present_minNumSegments = true;
        list.add(present_minNumSegments);
        if (present_minNumSegments) list.add(minNumSegments);
    ...
    private static class ScalingPolicyStandardScheme extends StandardScheme<ScalingPolicy> {
        ...
        public void read(org.apache.thrift.protocol.TProtocol iprot, ScalingPolicy struct) throws org.apache.thrift
                .TException {
                ...
                switch (schemeField.id) {
                    case 1: // TYPE
                        if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                            struct.type = com.emc.pravega.controller.stream.api.v1.ScalingPolicyType.findByValue(
                                    iprot.readI32());
            ...
            if (!struct.isSetTargetRate()) {
                throw new org.apache.thrift.protocol.TProtocolException(
                        "Required field 'targetRate' was not found in serialized data! Struct: " + toString());
            }
            if (!struct.isSetScaleFactor()) {
                throw new org.apache.thrift.protocol.TProtocolException(
                        "Required field 'scaleFactor' was not found in serialized data! Struct: " + toString());
            }
            if (!struct.isSetMinNumSegments()) {
                throw new org.apache.thrift.protocol.TProtocolException(
                        "Required field 'minNumSegments' was not found in serialized data! Struct: " + toString());
            }
            struct.validate();
        }
