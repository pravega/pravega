...
public class Position implements org.apache.thrift.TBase<Position, Position._Fields>, java.io.Serializable, Cloneable {
  ...
  public Position(Position other) {
    if (other.isSetOwnedLogs()) {
      Map<SegmentId,Long> __this__ownedLogs = new HashMap<SegmentId,Long>();
    ...
    if (other.isSetFutureOwnedLogs()) {
      Map<SegmentId,Long> __this__futureOwnedLogs = new HashMap<SegmentId,Long>();
  ...
  public int hashCode() {
    ...
    builder.append(present_ownedLogs);
    if (present_ownedLogs)
      builder.append(ownedLogs);

    boolean present_futureOwnedLogs = true && (isSetFutureOwnedLogs());
    builder.append(present_futureOwnedLogs);
    if (present_futureOwnedLogs)
      builder.append(futureOwnedLogs);
  ...
  public int compareTo(Position other) {
    ...
    lastComparison = Boolean.valueOf(isSetOwnedLogs()).compareTo(typedOther.isSetOwnedLogs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOwnedLogs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ownedLogs, typedOther.ownedLogs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetFutureOwnedLogs()).compareTo(typedOther.isSetFutureOwnedLogs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFutureOwnedLogs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.futureOwnedLogs, typedOther.futureOwnedLogs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  SegmentId _key2; // required
                  long _val3; // required
                  _key2 = new SegmentId();
                  _key2.read(iprot);
                  _val3 = iprot.readI64();
                  struct.ownedLogs.put(_key2, _val3);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  SegmentId _key6; // required
                  long _val7; // required
                  _key6 = new SegmentId();
                  _key6.read(iprot);
                  _val7 = iprot.readI64();
                  struct.futureOwnedLogs.put(_key6, _val7);
                }
                iprot.readMapEnd();
              }
  ...
  private static class PositionTupleScheme extends TupleScheme<Position> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Position struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        {
          SegmentId _key14; // required
          long _val15; // required
          _key14 = new SegmentId();
          _key14.read(iprot);
          _val15 = iprot.readI64();
          struct.ownedLogs.put(_key14, _val15);
        }
      }
      struct.setOwnedLogsIsSet(true);
      {
        ...
        {
          SegmentId _key18; // required
          long _val19; // required
          _key18 = new SegmentId();
          _key18.read(iprot);
          _val19 = iprot.readI64();
          struct.futureOwnedLogs.put(_key18, _val19);
        }
      }
      struct.setFutureOwnedLogsIsSet(true);
    }
