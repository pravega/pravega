...
public class Position implements org.apache.thrift.TBase<Position, Position._Fields>, java.io.Serializable,
                                 Cloneable, Comparable<Position> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
            "Position");

    private static final org.apache.thrift.protocol.TField OWNED_SEGMENTS_FIELD_DESC = new org.apache.thrift.protocol
            .TField(
            "ownedSegments", org.apache.thrift.protocol.TType.MAP, (short) 1);
    private static final org.apache.thrift.protocol.TField FUTURE_OWNED_SEGMENTS_FIELD_DESC = new org.apache.thrift
            .protocol.TField(
            "futureOwnedSegments", org.apache.thrift.protocol.TType.MAP, (short) 2);
    ...
    static {
        Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift
                ...
                _Fields.class);
        tmpMap.put(_Fields.OWNED_SEGMENTS, new org.apache.thrift.meta_data.FieldMetaData("ownedSegments",
                org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP,
                        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
                                SegmentId.class),
                        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64))));
        tmpMap.put(_Fields.FUTURE_OWNED_SEGMENTS, new org.apache.thrift.meta_data.FieldMetaData("futureOwnedSegments",
                org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP,
                        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
                                FutureSegment.class),
    ...
    public Position(Map<SegmentId, Long> ownedSegments, Map<FutureSegment, Long> futureOwnedSegments) {
        this();
    ...
    public Position(Position other) {
        ...
        if (other.isSetFutureOwnedSegments()) {
            Map<FutureSegment, Long> __this__futureOwnedSegments = new HashMap<FutureSegment, Long>(
                    other.futureOwnedSegments.size());
            for (Map.Entry<FutureSegment, Long> other_element : other.futureOwnedSegments.entrySet()) {
                ...
                __this__futureOwnedSegments.put(__this__futureOwnedSegments_copy_key,
                        __this__futureOwnedSegments_copy_value);
            }
    ...
    public boolean equals(Object that) {
        ...
        if (that instanceof Position) return this.equals((Position) that);
        return false;
    }
    ...
    public boolean equals(Position that) {
        ...
        if (this_present_ownedSegments || that_present_ownedSegments) {
            if (!(this_present_ownedSegments && that_present_ownedSegments)) return false;
            if (!this.ownedSegments.equals(that.ownedSegments)) return false;
        }
        ...
        if (this_present_futureOwnedSegments || that_present_futureOwnedSegments) {
            if (!(this_present_futureOwnedSegments && that_present_futureOwnedSegments)) return false;
            if (!this.futureOwnedSegments.equals(that.futureOwnedSegments)) return false;
        }
    ...
    public int hashCode() {
        ...
        if (present_ownedSegments) list.add(ownedSegments);

        boolean present_futureOwnedSegments = true && (isSetFutureOwnedSegments());
        list.add(present_futureOwnedSegments);
        if (present_futureOwnedSegments) list.add(futureOwnedSegments);
    ...
    public int compareTo(Position other) {
        ...
        if (isSetFutureOwnedSegments()) {
            lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.futureOwnedSegments,
                    other.futureOwnedSegments);
            if (lastComparison != 0) {
                return lastComparison;
            }
        }
    ...
    public void validate() throws org.apache.thrift.TException {
        ...
        if (ownedSegments == null) {
            throw new org.apache.thrift.protocol.TProtocolException(
                    "Required field 'ownedSegments' was not present! Struct: " + toString());
        }
        if (futureOwnedSegments == null) {
            throw new org.apache.thrift.protocol.TProtocolException(
                    "Required field 'futureOwnedSegments' was not present! Struct: " + toString());
        }
    ...
    private static class PositionStandardScheme extends StandardScheme<Position> {
        ...
        public void read(org.apache.thrift.protocol.TProtocol iprot, Position struct) throws org.apache.thrift
                .TException {
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, Position struct) throws org.apache.thrift
                .TException {
            struct.validate();
            ...
            if (struct.ownedSegments != null) {
                oprot.writeFieldBegin(OWNED_SEGMENTS_FIELD_DESC);
                {
                    oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT,
                            org.apache.thrift.protocol.TType.I64, struct.ownedSegments.size()));
            ...
            if (struct.futureOwnedSegments != null) {
                ...
                {
                    oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT,
                            org.apache.thrift.protocol.TType.I64, struct.futureOwnedSegments.size()));
        ...
        public void read(org.apache.thrift.protocol.TProtocol prot, Position struct) throws org.apache.thrift.TException {
            TTupleProtocol iprot = (TTupleProtocol) prot;
            {
                org.apache.thrift.protocol.TMap _map12 = new org.apache.thrift.protocol.TMap(
                        org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.I64, iprot.readI32());
