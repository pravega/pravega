...
public class Position implements org.apache.thrift.TBase<Position, Position._Fields>, java.io.Serializable,
    ...
    private static final org.apache.thrift.protocol.TField OWNED_SEGMENTS_FIELD_DESC = new org.apache.thrift.protocol
            .TField("ownedSegments", org.apache.thrift.protocol.TType.MAP, (short) 1);
    private static final org.apache.thrift.protocol.TField FUTURE_OWNED_SEGMENTS_FIELD_DESC = new org.apache.thrift
            .protocol.TField("futureOwnedSegments", org.apache.thrift.protocol.TType.MAP, (short) 2);
    ...
    static {
        ...
        tmpMap.put(_Fields.OWNED_SEGMENTS, new org.apache.thrift.meta_data.FieldMetaData("ownedSegments", org.apache
                .thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP,
                        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
                                SegmentId.class),
                        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64))));
        tmpMap.put(_Fields.FUTURE_OWNED_SEGMENTS, new org.apache.thrift.meta_data.FieldMetaData
                ("futureOwnedSegments", org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP,
                        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
                                FutureSegment.class),
                        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64))));
    ...
    public Position(Position other) {
        ...
        if (other.isSetFutureOwnedSegments()) {
            Map<FutureSegment, Long> __this__futureOwnedSegments = new HashMap<FutureSegment, Long>(other
                    .futureOwnedSegments.size());
    ...
    public int compareTo(Position other) {
        ...
        if (isSetFutureOwnedSegments()) {
            lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.futureOwnedSegments, other
                    .futureOwnedSegments);
            if (lastComparison != 0) {
                return lastComparison;
            }
    ...
    public void validate() throws org.apache.thrift.TException {
        ...
        if (ownedSegments == null) {
            throw new org.apache.thrift.protocol.TProtocolException("Required field 'ownedSegments' was not present! " +
                    "Struct: " + toString());
        }
        if (futureOwnedSegments == null) {
            throw new org.apache.thrift.protocol.TProtocolException("Required field 'futureOwnedSegments' was not " +
