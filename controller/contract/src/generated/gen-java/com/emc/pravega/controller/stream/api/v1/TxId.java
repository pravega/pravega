...
public class TxId implements org.apache.thrift.TBase<TxId, TxId._Fields>, java.io.Serializable, Cloneable,
                             Comparable<TxId> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
            "TxId");

    private static final org.apache.thrift.protocol.TField HIGH_BITS_FIELD_DESC = new org.apache.thrift.protocol.TField(
            "highBits", org.apache.thrift.protocol.TType.I64, (short) 1);
    private static final org.apache.thrift.protocol.TField LOW_BITS_FIELD_DESC = new org.apache.thrift.protocol.TField(
            "lowBits", org.apache.thrift.protocol.TType.I64, (short) 2);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>,
            SchemeFactory>();

    static {
        schemes.put(StandardScheme.class, new TxIdStandardSchemeFactory());
        schemes.put(TupleScheme.class, new TxIdTupleSchemeFactory());
    }
    ...
    static {
        Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift
                ...
                _Fields.class);
        tmpMap.put(_Fields.HIGH_BITS, new org.apache.thrift.meta_data.FieldMetaData("highBits",
                org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
        tmpMap.put(_Fields.LOW_BITS, new org.apache.thrift.meta_data.FieldMetaData("lowBits",
                org.apache.thrift.TFieldRequirementType.REQUIRED,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
        metaDataMap = Collections.unmodifiableMap(tmpMap);
        org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TxId.class, metaDataMap);
    }

    public TxId() {
    }

    public TxId(long highBits, long lowBits) {
        this();
     ...
     */
    public TxId(TxId other) {
        __isset_bitfield = other.__isset_bitfield;
        this.highBits = other.highBits;
        this.lowBits = other.lowBits;
    }

    public TxId deepCopy() {
        return new TxId(this);
    }
    ...
    public TxId setHighBits(long highBits) {
        this.highBits = highBits;
        setHighBitsIsSet(true);
        return this;
    }
    ...
    public TxId setLowBits(long lowBits) {
        this.lowBits = lowBits;
        setLowBitsIsSet(true);
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        if (that instanceof TxId) return this.equals((TxId) that);
        return false;
    }

    public boolean equals(TxId that) {
        if (that == null) return false;

        boolean this_present_highBits = true;
        boolean that_present_highBits = true;
        if (this_present_highBits || that_present_highBits) {
            if (!(this_present_highBits && that_present_highBits)) return false;
            if (this.highBits != that.highBits) return false;
        }

        boolean this_present_lowBits = true;
        boolean that_present_lowBits = true;
        if (this_present_lowBits || that_present_lowBits) {
            if (!(this_present_lowBits && that_present_lowBits)) return false;
            if (this.lowBits != that.lowBits) return false;
        }
    ...
    public int hashCode() {
        ...
        if (present_highBits) list.add(highBits);

        boolean present_lowBits = true;
        list.add(present_lowBits);
        if (present_lowBits) list.add(lowBits);
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TxId(");
        boolean first = true;
    ...
    private static class TxIdStandardSchemeFactory implements SchemeFactory {
        public TxIdStandardScheme getScheme() {
            return new TxIdStandardScheme();
        }
    }

    private static class TxIdStandardScheme extends StandardScheme<TxId> {

        public void read(org.apache.thrift.protocol.TProtocol iprot, TxId struct) throws org.apache.thrift.TException {
            ...
            if (!struct.isSetHighBits()) {
                throw new org.apache.thrift.protocol.TProtocolException(
                        "Required field 'highBits' was not found in serialized data! Struct: " + toString());
            }
            if (!struct.isSetLowBits()) {
                throw new org.apache.thrift.protocol.TProtocolException(
                        "Required field 'lowBits' was not found in serialized data! Struct: " + toString());
            }
            struct.validate();
        }

        public void write(org.apache.thrift.protocol.TProtocol oprot, TxId struct) throws org.apache.thrift.TException {
            struct.validate();
    ...
    private static class TxIdTupleSchemeFactory implements SchemeFactory {
        public TxIdTupleScheme getScheme() {
            return new TxIdTupleScheme();
        }
    }

    private static class TxIdTupleScheme extends TupleScheme<TxId> {

        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, TxId struct) throws org.apache.thrift.TException {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, TxId struct) throws org.apache.thrift.TException {
