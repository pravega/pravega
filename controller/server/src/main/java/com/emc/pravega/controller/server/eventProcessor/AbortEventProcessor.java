...
import com.emc.pravega.controller.eventProcessor.EventProcessor;
...
public class AbortEventProcessor extends EventProcessor<AbortEvent>  {
    ...
    public AbortEventProcessor(final StreamMetadataStore streamMetadataStore, final HostControllerStore hostControllerStore) {
