...
/**
 * Metric collector is responsible for distributing metrics to respective monitors.
 * It creates a monitor object per entity that it needs to monitor and maintains a mapping.
 * So one streamMonitor object per stream and one hostMonitor object per host.
 * All metrics specific to a stream are sent to the corresponding stream monitor object.
 *
