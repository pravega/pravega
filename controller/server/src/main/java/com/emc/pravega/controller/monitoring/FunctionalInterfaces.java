...
public class FunctionalInterfaces {
     ...
     */
    @FunctionalInterface
    public interface AggregateFunction<T extends AggregatedValue, V, M extends Metric, H extends History<M, V>> {
        T compute(final M metric, final T previous, final H history);
    }
}
