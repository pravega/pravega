 ...
 */
public class SegmentAggregator implements FunctionalInterfaces.AggregateFunction<SegmentQuantileValue, Event, EventHistory> {
     ...
     */
    @Override
    public SegmentQuantileValue compute(StreamMetric metric, SegmentQuantileValue value, EventHistory history) {
        value.update(metric);
        return value;
    }
}
