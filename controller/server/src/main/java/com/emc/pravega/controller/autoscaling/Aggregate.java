 ...
 */
public class Aggregate<V, T extends AggregatedValue<V>, S, H extends History<StreamMetric, S>> {
    private final FunctionalInterfaces.AggregateFunction<T, S, H> aggFunction;

    private final T aggregatedValue;

    public Aggregate(FunctionalInterfaces.AggregateFunction<T, S, H> aggFunction, T aggregatedValue) {
    ...
    public FunctionalInterfaces.AggregateFunction<T, S, H> getAggFunction() {
        return aggFunction;
    }
}
