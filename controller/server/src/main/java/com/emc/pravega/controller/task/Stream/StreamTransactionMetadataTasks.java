...
public class StreamTransactionMetadataTasks extends TaskBase {
    ...
    public CompletableFuture<Boolean> dropTx(String scope, String stream, UUID txId) {
        throw new NotImplementedException();
    }
    ...
    public CompletableFuture<Boolean> commitTx(String scope, String stream, UUID txId) {
        throw new NotImplementedException();
    }
}
