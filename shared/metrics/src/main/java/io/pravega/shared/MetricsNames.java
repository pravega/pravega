...
public final class MetricsNames {
    ...
    public static final String SEGMENT_CREATE_LATENCY = "segment.create_latency_ms";              // Histogram
    public static final String SEGMENT_DELETE_LATENCY = "segment.delete_latency_ms";              // Histogram
    public static final String SEGMENT_READ_LATENCY = "segment.read_latency_ms";                  // Histogram
    public static final String SEGMENT_WRITE_LATENCY = "segment.write_latency_ms";                // Histogram
    ...
    // Table Segment stats
    public static final String TABLE_SEGMENT_UPDATE_LATENCY = "tablesegment.update_latency_ms";                         // Histogram
    public static final String TABLE_SEGMENT_UPDATE_CONDITIONAL_LATENCY = "tablesegment.update_conditional_latency_ms"; // Histogram
    public static final String TABLE_SEGMENT_REMOVE_LATENCY = "tablesegment.remove_latency_ms";                         // Histogram
    public static final String TABLE_SEGMENT_REMOVE_CONDITIONAL_LATENCY = "tablesegment.remove_conditional_latency_ms"; // Histogram
    public static final String TABLE_SEGMENT_GET_LATENCY = "tablesegment.get_latency_ms";                               // Histogram
    public static final String TABLE_SEGMENT_ITERATE_KEYS_LATENCY = "tablesegment.iterate_keys_latency_ms";             // Histogram
    public static final String TABLE_SEGMENT_ITERATE_ENTRIES_LATENCY = "tablesegment.iterate_entries_latency_ms";       // Histogram
    ...
    public static final String PROCESS_OPERATIONS_LATENCY = "container.process_operations.latency_ms";                 // Per-container Histogram
    public static final String PROCESS_OPERATIONS_BATCH_SIZE = "container.process_operations.batch_size";              // Per-container Histogram
    public static final String OPERATION_QUEUE_SIZE = "container.operation_queue.size";                                // Per-container Histogram
    public static final String OPERATION_PROCESSOR_IN_FLIGHT = "container.operation_processor.in_flight";              // Per-container Histogram
    public static final String OPERATION_QUEUE_WAIT_TIME = "container.operation_queue.wait_time";                      // Per-container Histogram
    public static final String OPERATION_PROCESSOR_DELAY_MILLIS = "container.operation_processor.delay_ms";            // Per-container Histogram
    public static final String OPERATION_COMMIT_LATENCY = "container.operation_commit.latency_ms";                     // Per-container Histogram
    public static final String OPERATION_LATENCY = "container.operation.latency_ms";                                   // Per-container Histogram
    public static final String OPERATION_COMMIT_METADATA_TXN_COUNT = "container.operation_commit.metadata_txn_count";  // Per-container Histogram
    public static final String OPERATION_COMMIT_MEMORY_LATENCY = "container.operation_commit.memory_latency_ms";       // Per-container Histogram
    ...
    // Thread pool metrics
    public static final String THREAD_POOL_QUEUE_SIZE = "thread_pool.queue_size";          // Histogram
    public static final String THREAD_POOL_ACTIVE_THREADS = "thread_pool.active_threads";  // Histogram

    // Metrics in Controller
    // Stream request counts
    public static final String CREATE_STREAM = "controller.stream.created";                         // Counter
    public static final String CREATE_STREAM_LATENCY = "stream.created_latency_ms";                 // Histogram
    ...
    public static final String SEAL_STREAM_LATENCY = "stream.sealed_latency_ms";                    // Histogram
    ...
    public static final String DELETE_STREAM_LATENCY = "stream.deleted_latency_ms";                 // Histogram
    ...
    public static final String UPDATE_STREAM_LATENCY = "stream.updated_latency_ms";                 // Histogram
    ...
    public static final String TRUNCATE_STREAM_LATENCY = "stream.truncated_latency_ms";             // Histogram
    ...
    public static final String CREATE_TRANSACTION_LATENCY = "transactions.created_latency_ms";              // Histogram
    ...
    public static final String COMMIT_TRANSACTION_LATENCY = "transactions.committed_latency_ms";            // Histogram
    ...
    public static final String ABORT_TRANSACTION_LATENCY = "transactions.aborted_latency_ms";               // Histogram
