...
import io.pravega.shared.protocol.WireCommands.OperationUnsupported;
import io.pravega.shared.protocol.WireCommands.SegmentAlreadyExists;
import io.pravega.shared.protocol.WireCommands.SegmentAttribute;
import io.pravega.shared.protocol.WireCommands.SegmentAttributeUpdated;
import io.pravega.shared.protocol.WireCommands.SegmentCreated;
import io.pravega.shared.protocol.WireCommands.SegmentDeleted;
import io.pravega.shared.protocol.WireCommands.SegmentIsSealed;
import io.pravega.shared.protocol.WireCommands.SegmentIsTruncated;
import io.pravega.shared.protocol.WireCommands.SegmentPolicyUpdated;
import io.pravega.shared.protocol.WireCommands.SegmentRead;
import io.pravega.shared.protocol.WireCommands.SegmentSealed;
import io.pravega.shared.protocol.WireCommands.SegmentTruncated;
import io.pravega.shared.protocol.WireCommands.SegmentsMerged;
import io.pravega.shared.protocol.WireCommands.StreamSegmentInfo;
import io.pravega.shared.protocol.WireCommands.TableEntriesDeltaRead;
import io.pravega.shared.protocol.WireCommands.TableEntriesRead;
import io.pravega.shared.protocol.WireCommands.TableEntriesUpdated;
import io.pravega.shared.protocol.WireCommands.TableKeyBadVersion;
import io.pravega.shared.protocol.WireCommands.TableKeyDoesNotExist;
import io.pravega.shared.protocol.WireCommands.TableKeysRead;
import io.pravega.shared.protocol.WireCommands.TableKeysRemoved;
import io.pravega.shared.protocol.WireCommands.TableRead;
import io.pravega.shared.protocol.WireCommands.TableSegmentNotEmpty;
import io.pravega.shared.protocol.WireCommands.WrongHost;
