...
sed -i 's|journalDirectory=/tmp/bk-txn|journalDirectory=/journal|' /opt/bk_all/bookkeeper-server-4.4.0/conf/bk_server.conf
sed -i 's|ledgerDirectories=/tmp/bk-data|ledgerDirectories=/ledgers|' /opt/bk_all/bookkeeper-server-4.4.0/conf/bk_server.conf
