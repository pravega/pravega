...
public class DataFrameBuilder implements AutoCloseable {
    ...
    private final DataFrameLog targetLog;
     ...
     * @param targetLog                      The DataFrameLog to publish completed Data Frames to.
     * @param dataFrameCommitSuccessCallback A callback that will be invoked upon every successful commit of a Data Frame.
     *                                       When this is called, all entries added via add() that were successful have
     ...
     *                                       When this is called, all entries added via add() that were successful have
     *                                       failed to commit. The in-flight entries will be failed via the add() method.
    ...
    public DataFrameBuilder(int maxDataFrameSize, DataFrameLog targetLog, Consumer<DataFrameCommitArgs> dataFrameCommitSuccessCallback, Consumer<Exception> dataFrameCommitFailureCallback) {
        ...
        this.outputStream = new DataFrameOutputStream(maxDataFrameSize, targetLog::getLastMagic, this::handleDataFrameComplete);
    ...
    public void append(Operation operation) throws SerializationException {
        ...
        try {
            ...
            throw new SerializationException("DataFrameBuilder.add", "Unable to add an operation to the DataFrameOutputStream.", ex);
        }
    ...
    private class DataFrameOutputStream extends OutputStream {
        ...
        private final Supplier<Integer> getNextMagic;
         ...
         *
         * @param maxDataFrameSize          The maximum size, in bytes, of a Data Frame.
         * @param getNextMagic              A method that generates correct Magic Numbers for the next Frame (PreviousFrame.EndMagic == NextFrame.StartMagic for chaining to work).
        ...
        public DataFrameOutputStream(int maxDataFrameSize, Supplier<Integer> getNextMagic, Function<DataFrame, Boolean> dataFrameCompleteCallback) {
            ...
            this.getNextMagic = getNextMagic;
        ...
        private void createNewFrame() {
            ...
            this.currentFrame = new DataFrame(this.getNextMagic.get(), this.maxDataFrameSize);
