...
//                tableSegmentOperations.add(valueBytes.length == 0 ? new TableSegmentUtils.DeleteOperation(TableSegmentEntry.versioned(keyBytes, valueBytes, header.getEntryVersion())) : new TableSegmentUtils.PutOperation(TableSegmentEntry.versioned(keyBytes, valueBytes, header.getEntryVersion())));
