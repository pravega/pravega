...
public class EventProcessorTest extends ThreadPooledTestSuite {
    ...
    @Test(timeout = 180000)
    public void testEventProcessorInterruptBlock() throws Exception {
        final String scope = "controllerEventProcessorScope";
        final String streamName = "streamEventProcessor";
        final String readerGroup = "readerGroupEventProcessor";
