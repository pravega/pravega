...
class OutOfProcessAdapter extends ExternalAdapter {
    ...
    private Process startController(int controllerId) throws IOException {
        ...
        Process p = ProcessStarter
                ...
                .sysProp(configProperty(Config.COMPONENT_CODE, Config.PROPERTY_TLS_PROTOCOL_VERSION), SecurityConfigDefaults.TLS_PROTOCOL_VERSION)
    ...
    private Process startSegmentStore(int segmentStoreId) throws IOException {
        ...
        ProcessStarter ps = ProcessStarter
                ...
                .sysProp(configProperty(ServiceConfig.COMPONENT_CODE, ServiceConfig.TLS_PROTOCOL_VERSION), SecurityConfigDefaults.TLS_PROTOCOL_VERSION)
