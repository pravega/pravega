...
public class BasicAuthTest extends AbstractReadWriteTest {
    ...
    public static void initialize() {
        ...
        PravegaProperties props = PravegaProperties.buildWithAuth(zkUri);
        URI controllerUri = ensureControllerRunning(zkUri, props);
        ensureSegmentStoreRunning(zkUri, controllerUri, props);
    }
