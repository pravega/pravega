...
@Slf4j
public class ZookeeperService extends DockerBasedService {
    ...
    public ZookeeperService(String serviceName) {
        super(serviceName);
    }
    ...
    public static void main(String[] args) {
        ZookeeperService zookeeperService = new ZookeeperService("zookeeper");
