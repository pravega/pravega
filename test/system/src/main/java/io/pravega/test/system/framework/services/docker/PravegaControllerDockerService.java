...
public class PravegaControllerDockerService extends DockerBasedService {
    ...
    private ServiceSpec setServiceSpec() {
        ...
        stringBuilderMap.put("controller.transaction.maxLeaseValue", String.valueOf(120 * 1000));
        ...
        final TaskSpec taskSpec = TaskSpec
                ...
                .containerSpec(ContainerSpec.builder().image(IMAGE_PATH + IMAGE_PREFIX + "/pravega:" + PRAVEGA_VERSION)
