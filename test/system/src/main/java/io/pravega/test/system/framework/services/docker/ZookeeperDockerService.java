...
public class ZookeeperDockerService extends DockerBasedService {
    ...
    private static final String ZOOKEEPER_VERSION = System.getProperty("zookeeperVersion", "latest");
    ...
    private ServiceSpec setServiceSpec() {
        ...
        final TaskSpec taskSpec = TaskSpec
                .builder()
                .containerSpec(ContainerSpec.builder().image(IMAGE_PATH + IMAGE_PREFIX + ZOOKEEPER_IMAGE_NAME + ZOOKEEPER_VERSION)
