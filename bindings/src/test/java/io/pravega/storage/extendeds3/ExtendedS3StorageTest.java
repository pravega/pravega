    ...
    public void testCreateIfNoneMatch() {
        val adapterConfig = ExtendedS3StorageConfig.builder()
                .with(ExtendedS3StorageConfig.BUCKET, setup.adapterConfig.getBucket())
                                               ...
                                               .with(ExtendedS3StorageConfig.PREFIX, "test")
