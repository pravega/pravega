 ...
 * Test factories.
 */
public class ExtendedS3StorageFactoryTests extends ThreadPooledTestSuite {
    @Override
    ...
    public void testExtendedS3StorageFactoryCreator() {
        ...
        Assert.assertEquals(executorService(), ((ExtendedS3SimpleStorageFactory) factory1).getExecutor());
        Assert.assertEquals(ChunkedSegmentStorageConfig.DEFAULT_CONFIG, ((ExtendedS3SimpleStorageFactory) factory1).getChunkedSegmentStorageConfig());
