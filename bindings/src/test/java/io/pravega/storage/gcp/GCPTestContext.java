...
public class GCPTestContext {
    ...
    public GCPTestContext() throws IOException {
            ...
            /*GoogleCredentials credentials = GoogleCredentials.fromStream(new ByteArrayInputStream(jsonObject.toJSONString().getBytes()))
