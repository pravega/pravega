...
public class HDFSStorageConfig {
    ...
    public static final Property<String> URL = Property.named("connect.uri", "localhost:9000");
    public static final Property<String> ROOT = Property.named("root", "");
    public static final Property<Integer> REPLICATION = Property.named("replication.factor", 3);
    public static final Property<Integer> BLOCK_SIZE = Property.named("block.size", 1024 * 1024);
    public static final Property<Boolean> REPLACE_DATANODES_ON_FAILURE = Property.named("replaceDataNodesOnFailure.enable", true);
